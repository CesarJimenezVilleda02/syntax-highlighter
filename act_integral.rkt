...
(define rgx_matcher #rx"\\/\\/.*||\\-*[0-9]+\\.[0-9]+((E|e)-*[0-9]*)*|\\auto|\\else|\\long|\\switch|\\break|\\enum|\\register|\\typedef|\\case|\\extern|\\return|\\union|\\char|\\float|\\short|\\unsigned|\\const|\\for|\\signed|\\void|\\continue|\\goto|\\sizeof|\\volatile|\\default|\\if|\\stati|\\while|\\do|\\int|\\struct_Packed|\\double|[a-zA-Z][a-zA-Z0-9_]*|\\-*[0-9]+|\\^|\\/|\\&|\\||\\+|\\-|\\*|\\=|\\(|\\)|.")
...
(define (detect-token l)
    (cond
      ...
      [(regexp-match? #rx"\\auto|\\else|\\long|\\switch|\\break|\\enum|\\register|\\typedef|\\case|\\extern|\\return|\\union|\\char|\\float|\\short|\\unsigned|\\const|\\for|\\signed|\\void|\\continue|\\goto|\\sizeof|\\volatile|\\default|\\if|\\stati|\\while|\\do|\\int|\\struct_Packed|\\double" l) (string-append "<span class=\"palabraReservada\">" l "</span>")]
